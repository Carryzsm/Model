  ...
  <div id="addressModel" @click="$emit('cancel')">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-footer" style="margin-left: 98px">
        <button type="button" class="sui-btn btn-primary btn-large" @click="$emit('confirm', addressInfo)">
          确定
        </button>
        <button type="button" class="sui-btn btn-default btn-large" @click="$emit('cancel')">
          取消
        </button>
      </div>
    </div>
